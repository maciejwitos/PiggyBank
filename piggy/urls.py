...
urlpatterns = [
    ...
    path('password_change/', auth_views.PasswordChangeView.as_view(template_name='user/password_change.html', success_url='/password_change/done/'), name='change-password'),
    path('password_change/done/', auth_views.PasswordChangeDoneView.as_view(template_name='user/password_change_success.html'), name='change-password-success'),
    ...
    path('category/delete/<int:pk>/', DeleteCategory.as_view(template_name='confirm_delete.html', success_url='/category/all/'), name='delete-category'),

    path('account/add/', AddAccount.as_view(), name='add-account'),
    path('account/all/', ReadAccounts.as_view(), name='all-account'),
    path('account/delete/<int:pk>/', DeleteAccount.as_view(template_name='confirm_delete.html', success_url='/account/all/'), name='delete-account'),
    path('account/<int:id>/', ReadOneAccount.as_view()),
    ...
    path('transaction/delete/<int:pk>/', DeleteTransaction.as_view(template_name='confirm_delete.html', success_url='/transaction/all'), name='delete-transaction'),
